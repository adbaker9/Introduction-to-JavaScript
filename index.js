...
let shrimp = 'taco';
let food = 'yummy';
if (food === 'yummy')  {shrimp = 'chicken'}
else {shrimp = 'taco'}
console.log{task 1 b:', shrimp}
...
console.log('task 1 c:;, Number(birthYear));')
...
function multiply(a,b){
  ...
  console.log('task 1 d:', multiply(3,8));
...
function hungryDog(weight, age){
    ...
    else if(age>=1 && weight>=6 && weight weight<=10){
      return weight * 0.04;}
...
*/
let cpu = math.random();
if cpu <=0.333){cpu = 'rock';}
else if (cpu <=0.666{ cpu = 'paper'})
...
function grade(score){
 ...
 else  (score < 90 && number >=80){
   return 'you got a B'

 } 
  else (score< 80 && number >=70){
    return 'you got a c'
  }
  else (score< 70 && number >=70){
    return 'you got a D'
  }
else if (score<60){
  return 'you got an F'
